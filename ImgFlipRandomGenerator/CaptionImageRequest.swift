...
class CaptionImageRequest: BaseRequest {
    ...
    override func path() -> String {
        ...
        let url :String = "\(apiEndpointURL)/caption_image?template_id=\(self.template_id)&username=\(self.username)&password=\(self.password)&text0=\(self.text1)&text1=\(self.text1)"
